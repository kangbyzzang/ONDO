    ...
    <section className="algorithm-panel" id="algorithm">
      <header className="algorithm-header">
        <div>
          ...
          <h2>현재 매칭 알고리즘</h2>
          <p>이 화면은 실제 계산 코드의 설정을 그대로 보여줍니다. 변경하고 싶은 규칙명이나 수치를 알려주면 해당 설정을 수정할 수 있어요.</p>
        </div>
      ...
      <div className="algorithm-section">
        ...
        <div className="question-rule-table-wrap">
          <table className="question-rule-table">
            <thead><tr><th>ID</th><th>질문</th><th>모듈</th><th>매칭 로직</th><th>기본 가중치</th><th>설정</th></tr></thead>
            <tbody>
