...
운영 주소: `https://eeumdating.vercel.app`
...
- Authentication > Settings > Authorized domains에 `eeumdating.vercel.app`
- 기존 `ondo-korea-japan-theta.vercel.app` 주소는 이전 링크 호환용으로 유지
